# Laravel Secure Coding Patterns

Concrete patterns for the OWASP Top 10 as they apply to Laravel. Each section
shows the safe pattern and, where useful, the anti-pattern to avoid.
