# Laravel Cashier Subscriptions Reference

Installation, configuration, Billable model setup, subscription management, single charges, and payment methods for Laravel Cashier (Stripe).
